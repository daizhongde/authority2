...
import com.asiainfo.authority.hibernate.dao.TAuthorityUrrelationDAO;
 ...
 * 
 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelation
...
public class TAuthorityUrrelationDAOImpl extends SpringHibernateDaoSupport implements TAuthorityUrrelationDAO {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#save(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#delete(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findById(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelationId)
	 */
	public TAuthorityUrrelation findById(
		...
		try {
			TAuthorityUrrelation instance = (TAuthorityUrrelation) getHibernateTemplate()
					.get("com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findByExample(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findByCCip(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findByCCreator(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#findAll()
	 */
	public List findAll() {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#merge(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#attachDirty(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityUrrelationDAO#attachClean(com.asiainfo.authority.hibernate.pojo.TAuthorityUrrelation)
	 */
