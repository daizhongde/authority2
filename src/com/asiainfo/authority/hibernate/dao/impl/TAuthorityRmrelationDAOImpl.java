...
import com.asiainfo.authority.hibernate.dao.TAuthorityRmrelationDAO;
 ...
 * 
 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelation
...
public class TAuthorityRmrelationDAOImpl extends SpringHibernateDaoSupport implements TAuthorityRmrelationDAO {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#save(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#delete(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
...
//		Printer.printJSON(list);
	...
	public TAuthorityRmrelation findById(
		...
		try {
			TAuthorityRmrelation instance = (TAuthorityRmrelation) getHibernateTemplate()
					.get("com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#findByExample(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#findByCCip(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#findByCCreator(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#findAll()
	 */
	public List findAll() {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#merge(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#attachDirty(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRmrelationDAO#attachClean(com.asiainfo.authority.hibernate.pojo.TAuthorityRmrelation)
	 */
