 ...
 * 
 * @see com.asiainfo.migration.hibernate.dao.impl.TAuthorityRbrelation
...
public class TAuthorityRbrelationDAOImpl extends SpringHibernateDaoSupport implements TAuthorityRbrelationDAO {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#save(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#delete(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findById(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelationId)
	 */
	@Override
	public TAuthorityRbrelation findById(
		...
		try {
			TAuthorityRbrelation instance = (TAuthorityRbrelation) getHibernateTemplate()
					.get("com.asiainfo.migration.hibernate.pojo.TAuthorityRbrelation",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findByExample(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findByCCip(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findByCCreator(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#findAll()
	 */
	@Override
	public List findAll() {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#merge(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#attachDirty(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityRbrelationDAO#attachClean(com.asiainfo.authority.hibernate.pojo.TAuthorityRbrelation)
	 */
	@Override
