 ...
 * 
 * @see com.asiainfo.authority.hibernate.pojo.TAuthorityLevel
...
public class TAuthorityLevelDAOImpl extends SpringHibernateDaoSupport implements TAuthorityLevelDAO { 
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#save(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#delete(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#findById(java.lang.Short)
	 */
	@Override
	public TAuthorityLevel findById(java.lang.Short id) {
		...
		try {
			TAuthorityLevel instance = (TAuthorityLevel) getHibernateTemplate()
					.get("com.asiainfo.authority.hibernate.pojo.TAuthorityLevel", id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#findByExample(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#findByCLname(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#findAll()
	 */
	@Override
	public List findAll() {
		log.debug("finding all TAuthorityLevel instances");
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#merge(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#attachDirty(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.hibernate.dao.impl.TAuthorityLevelDAO#attachClean(com.asiainfo.authority.hibernate.pojo.TAuthorityLevel)
	 */
	@Override
