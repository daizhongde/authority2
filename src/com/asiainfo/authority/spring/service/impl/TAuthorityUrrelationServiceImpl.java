...
import com.asiainfo.authority.constant.AuthorityUrrelation;
...
import com.asiainfo.authority.spring.service.TAuthorityUrrelationService;
...
//		Object o= dataDAO.sqlQueryfindaValueByMap( sqlA.getCountSQL(), sqlA.getMap() );
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityUrrelationService#addWithId(java.lang.String)
	 */
	@Override
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityUrrelationService#modify(java.lang.String)
	 */
	@Override
...
//		return dataDAO.findById( Short.valueOf(id).shortValue() );
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityUrrelationService#delete(java.lang.String)
	 */
	@Override
