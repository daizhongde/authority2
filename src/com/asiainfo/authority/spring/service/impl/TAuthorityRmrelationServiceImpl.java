...
import com.asiainfo.authority.spring.service.TAuthorityRmrelationService;
...
//		Object o= dataDAO.sqlQueryfindaValueByMap( sqlA.getCountSQL(), sqlA.getMap() );
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityRmrelationService#addWithId(java.lang.String)
	 */
	@Override
...
//			pojo.setCLname(String.valueOf(map.get("name")));
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityRmrelationService#modify(java.lang.String)
	 */
	@Override
...
//		return dataDAO.findById( Short.valueOf(id).shortValue() );
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityRmrelationService#delete(java.lang.String)
	 */
	@Override
