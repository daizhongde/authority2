...
import com.asiainfo.authority.spring.service.TAuthorityButtonService;
...
//		Object o= dataDAO.sqlQueryfindaValueByMap( sqlA.getCountSQL(), sqlA.getMap() );
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityButtonService#addWithId(java.lang.String)
	 */
	@Override
...
//		batch.batchInsert(rows);
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityButtonService#modify(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.asiainfo.authority.spring.service.impl.TAuthorityButtonService#delete(java.lang.String)
	 */
	@Override
